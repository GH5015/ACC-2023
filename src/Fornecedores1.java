...
public class Fornecedores1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 20, -1, 510));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background-home3.png"))); // NOI18N
        jLabel1.setOpaque(true);
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 0, 660, 560));
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        try {
                    ...
                    PreparedStatement statement = connection.prepareStatement("INSERT INTO fornecedores (nome, produtoFornecido, cnpj, telefone) VALUES (?, ?, ?, ?)");
    ...
    String query = "SELECT id, nome, produtoFornecido, cnpj, telefone FROM fornecedores";
